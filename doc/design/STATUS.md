...
| **Remaining roadmap** — #9 compose-GUI v2 noun-first flow (incl. the #6 GUI caption + #10 "speak it back"), #11 plugin-TOML JSON Schema, #13 recent-action completion bias (§6.3; `goo again`/§6.1 shipped), #14 conversion-suggestions on 415, #15 `goo do <addr>` | **designed** | [data-entry-ux §8](data-entry-ux.md) |
